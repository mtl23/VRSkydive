...
public class Height : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        textField.text = ("POINTS" + match.GetComponent<Match>().score.ToString() + "\nHeight:" + player.transform.position.y.ToString() + "M\nRound: " + match.GetComponent<Match>().round.ToString());
    }
}
